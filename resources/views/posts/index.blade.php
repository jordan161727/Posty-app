...
@section('content')
 <div class="flex justify-center">
  <div class="w-8/12 bg-white p-6 rounded-lg">
       ...
       <form action="{{ route('posts')}}" method="post" class="m-4">
       @csrf
           <div class="mb-4">
            ...
            <div>
               ...
               <button type="submit" class="bg-blue-500 text-white px-4 py-4 py-2 rounded font-medium"
               >Post</button>
       ...
       @if ($posts->count())
          @foreach ($posts as $post)
                     <div class="mb-4">
                         <a href="" class="font-bold">{{ $post->user->name }}</a> <span class="tex-gray-600
                         ...
                         <div>
                         <form action="{{ route('posts.destroy', $post)}}" method="post" class="mr-1 mb-0">
                              @csrf
                              @method('DELETE')
